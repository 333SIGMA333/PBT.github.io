<header class="header">
        ...
        <ul id="header__cabinet_dropdown-menu">
            <li>
                <a href="/PBT_autorization/index.php" class="header__cabinet_enter">Войти</a>
            </li>
            <li>
                <a href="/PBT_registration/index.php" class="header__cabinet_registrartion">Регистрация</a>
            </li>
            <li>
